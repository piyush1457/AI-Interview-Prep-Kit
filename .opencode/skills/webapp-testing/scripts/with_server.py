...
import subprocess  # nosec: B404 - subprocess used for spawning test servers
import socket
import time
import sys
import argparse
    ...
    try:
        ...
        for i, server in enumerate(servers):
            ...
            process = subprocess.Popen(
                server["cmd"],
                shell=True,  # nosec: B602 - shell=True required for compound server startup commands
        ...
        result = subprocess.run(
            args.command
        )  # nosec: B603 - running user-provided test runner command
